...
<head>
    ...
    <title>CineManage Pro - Edit User</title>
                ...
                <form action="" method="POST" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name="fullname" required value="John Doe" 
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            <label class="block text-xs font-bold text-gray-400 tracking-wider uppercase mb-2">Role Group</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-400 tracking-wider uppercase mb-2">Account Status</label>
                            <select name="status" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-900 focus:outline-hidden focus:border-indigo-600 focus:bg-white focus:ring-4 focus:ring-indigo-100/50 transition">
                                <option value="Active" selected>Active</option>
                                <option value="Suspended">Suspended / Muted</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <div class="flex items-center space-x-3 w-full sm:w-auto justify-end">
                            <a href="users.php" class="px-5 py-2.5 bg-white border border-gray-200 text-gray-700 rounded-xl text-sm font-semibold hover:bg-gray-50 transition text-center">
                                Cancel
                            </a>
