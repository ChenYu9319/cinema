                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-gray-50/70 text-gray-500 text-xs font-bold uppercase tracking-wider border-b border-gray-100">
                                ...
                                <th class="py-3 px-5">Role Permission</th>
                        ...
                        <tbody class="text-sm divide-y divide-gray-100">
                            <tr class="hover:bg-slate-50/80 transition">
                                ...
                                <td class="py-3.5 px-5 font-semibold text-gray-900">admin_alan</td>
                                <td class="py-3.5 px-5 text-gray-600">admin@cinema.com</td>
                                <td class="py-3.5 px-5">
                                    <span class="text-xs font-bold uppercase px-2 py-0.5 rounded-sm bg-purple-50 text-purple-700 border border-purple-200/50">admin</span>
                                </td>
                            ...
                            <tr class="hover:bg-slate-50/80 transition">
                                ...
                                <td class="py-3.5 px-5 text-gray-600">bob@example.com</td>
                                <td class="py-3.5 px-5">
                                    <span class="text-xs font-bold uppercase px-2 py-0.5 rounded-sm bg-blue-50 text-blue-700 border border-blue-200/50">user</span>
                                </td>
                                <td class="py-3.5 px-5 text-right space-x-2">
                                    <button class="text-indigo-600 hover:text-indigo-900 font-medium text-xs cursor-pointer">Edit</button>
                                    <button class="text-rose-600 hover:text-rose-900 font-medium text-xs cursor-pointer">Delete</button>
                            ...
                            <tr class="hover:bg-slate-50/80 transition">
                                ...
                                <td class="py-3.5 px-5 text-gray-600">charlie@example.com</td>
                                <td class="py-3.5 px-5">
                                    <span class="text-xs font-bold uppercase px-2 py-0.5 rounded-sm bg-blue-50 text-blue-700 border border-blue-200/50">user</span>
                                </td>
                                <td class="py-3.5 px-5 text-right space-x-2">
